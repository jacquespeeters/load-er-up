...
if __name__ == '__main__':
    ...
    parser.add_argument('--actual', type=str, default='/opt/ml/processing/input/public/public.csv.gz')
    parser.add_argument('--predicted', type=str, default='/opt/ml/processing/input/predictions/public.csv.out')
    parser.add_argument('--output', type=str, default='/opt/ml/processing/output/scores/public.txt')
